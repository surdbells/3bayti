...
export const routes: Routes = [
  ...
  {
    /* Ask Ain — guided gift concierge (recipient/occasion/budget → real gift
       ideas + gift-card fallback). Public. */
    path: 'gift-ain',
    loadComponent: () =>
      import('./features/ai-concierge/gift-ain-page').then(m => m.GiftAinPageComponent),
