...
/**
 * POST /v3/me/customization-requests/{id}/reject
 *
 * Customer rejects the vendor's quote (terminal). Allowed only from
 * 'quoted'.
 */
final class RejectQuoteController
{
    use Responder;
    ...
    public function __invoke(
        ...
        try {
            $customization->rejectQuote();
        } catch (\DomainException $e) {
            throw new HttpException(
                status: 422,
                errorCode: 'CUSTOMIZATION_CANNOT_REJECT',
