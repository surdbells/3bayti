...
/**
 * POST /v3/vendor/chat/conversations/{uuid}/messages   body: { "content": "..." }
 *
 * Sends a message from the vendor to the customer, scoped to the vendor's
 * own stores. Same PII moderation as the customer side: a flagged message
 * is withheld with 422 CHAT_MESSAGE_BLOCKED.
 */
