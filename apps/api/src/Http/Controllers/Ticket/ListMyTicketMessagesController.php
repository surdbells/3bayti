...
/**
 * GET /v3/me/tickets/{id}/messages — the message thread for one of the
 * authenticated user's own tickets. 404 if not theirs (no existence leak).
 */
final class ListMyTicketMessagesController
{
    use Responder;
    ...
    public function __invoke(ServerRequestInterface $request): ResponseInterface
    {
        ...
        foreach ($ticket->getMessages() as $m) {
            $messages[] = $this->serializer->messageShape($m);
        }
